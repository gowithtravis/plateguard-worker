...
**Manual ticket number required:** ``kelley_ryan`` (Kelley & Ryan ePay MA towns),
``somerville_chs`` (Somerville via City Hall Systems). These are rechecked after batch
runs when stored violations exist; they are never queried from plate alone.
"""
